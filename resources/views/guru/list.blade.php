            ...
            <div class="kt-container  kt-container--fluid ">
                <div class="kt-subheader__main">
                    ...
                    <div class="kt-subheader__breadcrumbs">
                        ...
                        <a href="" class="kt-subheader__breadcrumbs-link"> Guru</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="kt-portlet">
                    <div class="kt-portlet__head">
                        ...
                        <div class="kt-portlet__head-label float-right">
                            <a href="{{ route('guru.create') }}" class="btn btn-outline-success btn-square"><i class="fa fa-plus"></i> Tambah</a>
                        </div>
                    </div>
                        ...
                        <table class="table table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
                            ...
                            @foreach ($result ?? [] as $row)
                                <tr>
                                    ...
                                    <td nowrap>
                                        <a href="{{ route('guru.edit', $row->id) }}" class="btn btn-sm btn-warning"><span class="fa fa-pencil-alt"></span></a>
