...
<head>
    ...
    <!--end::Base Path -->
    <meta charset="utf-8" />
    <title>VERA | Verify Entities Rights App</title>
...
<div id="kt_header_mobile" class="kt-header-mobile  kt-header-mobile--fixed ">
    <div class="kt-header-mobile__logo">
        <a href="{{ url('') }}"> <img alt="Logo" src="{{ asset('assets') }}/media/logos/logo-light.png" /> </a>
    </div>
        ...
        <div class="kt-aside  kt-aside--fixed  kt-grid__item kt-grid kt-grid--desktop kt-grid--hor-desktop" id="kt_aside">
            ...
            <div class="kt-aside__brand kt-grid__item " id="kt_aside_brand">
                <div class="kt-aside__brand-logo">
                    <a href="demo1/index.html"> <img alt="Logo" src="{{ asset('assets') }}/images/vera-white.png" width="150px" /> </a>
                </div>
                ...
                <div id="kt_aside_menu" class="kt-aside-menu " data-ktmenu-vertical="1" data-ktmenu-scroll="1" data-ktmenu-dropdown-timeout="500">
                    <ul class="kt-menu__nav ">
                        <li class="kt-menu__item " aria-haspopup="true">
                            <a href="{{ url('') }}" class="kt-menu__link "> <i class="kt-menu__link-icon flaticon-home"></i> <span class="kt-menu__link-text">Dashboard</span> </a>
                        </li>
                        ...
                        <li class="kt-menu__item " aria-haspopup="true">
                            <a href="{{ url('siswa') }}" class="kt-menu__link "> <i class="kt-menu__link-icon flaticon2-group"></i> <span class="kt-menu__link-text">Siswa</span> </a>
                        </li>

                        <li class="kt-menu__item " aria-haspopup="true">
                            <a href="{{ url('guru') }}" class="kt-menu__link "> <i class="kt-menu__link-icon flaticon-user"></i> <span class="kt-menu__link-text">Guru</span> </a>
                        </li>

                        <li class="kt-menu__item " aria-haspopup="true">
                            <a href="{{ url('kelas') }}" class="kt-menu__link "> <i class="kt-menu__link-icon flaticon-buildings"></i> <span class="kt-menu__link-text">Kelas</span> </a>
                        </li>

                        <li class="kt-menu__item " aria-haspopup="true">
                            <a href="{{ url('tahun-pelajaran') }}" class="kt-menu__link "> <i class="kt-menu__link-icon flaticon-calendar-1"></i> <span class="kt-menu__link-text">Tahun Pelajaran</span> </a>
                        </li>

                        <li class="kt-menu__item " aria-haspopup="true">
                            <a href="{{ url('logout') }}" class="kt-menu__link "><i class="kt-menu__link-icon flaticon-calendar-1"></i> <span class="kt-menu__link-text">Logout</span></a>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="kt-footer  kt-grid__item kt-grid kt-grid--desktop kt-grid--ver-desktop" id="kt_footer">
                <div class="kt-container  kt-container--fluid ">
                    <div class="kt-footer__copyright">
                        2019&nbsp;&copy;&nbsp;<a href="http://keenthemes.com/metronic" target="_blank" class="kt-link">superipey</a>
                    </div>
                </div>
            </div>
